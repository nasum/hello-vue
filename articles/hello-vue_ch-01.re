...
以上のように Vue.js とそれを取り巻く plugin などのエコシステムは、簡単な Web ページから Web アプリケーションまで様々な要求に対応することが可能です。plugin は主要なものは Evan さんにより公式なサポートが行われているため、連携も自然に出来るようになっており安心感をもって導入ですることができます。
